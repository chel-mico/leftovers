...
export const constants = {
    __prod__: consts.NODE_ENV === 'production',
    __secret__: consts.SECRET,
    __cache__: consts.CACHE!,
    __port__: parseInt(consts.PORT),
    __cookie__: 'qid',
    __uuid__: /\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b/
