...
let IngredientResolver = class IngredientResolver {
    ...
    addIngredient(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return Ingredient_1.Ingredient.create(Object.assign({}, input)).save();
        });
    }
};
__decorate([
...
__decorate([
    (0, type_graphql_1.Query)(() => Ingredient_1.Ingredient, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)("id", () => type_graphql_1.Int)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], IngredientResolver.prototype, "ingredient", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => Ingredient_1.Ingredient),
    __param(0, (0, type_graphql_1.Arg)("input")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [IngredientInput]),
    __metadata("design:returntype", Promise)
], IngredientResolver.prototype, "addIngredient", null);
