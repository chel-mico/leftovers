...
let UserResolver = class UserResolver {
    register(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newUser = yield User_1.User.create(Object.assign({}, input)).save();
            return {
                user: newUser
            };
        });
    ...
    userByName(name) {
        return User_1.User.findOne({ username: name });
    }
};
__decorate([
    (0, type_graphql_1.Mutation)(() => UserResponse),
    __param(0, (0, type_graphql_1.Arg)('input', () => Login)),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Login, typeof (_b = typeof types_1.Context !== "undefined" && types_1.Context) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
